...
public class Failure extends org.apache.avro.specific.SpecificExceptionBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1334520012023255404L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"error\",\"name\":\"Failure\",\"namespace\":\"protocols.replication\",\"doc\":\"Failure\",\"fields\":[{\"name\":\"info\",\"type\":\"string\"}]}");
   ...
   */
  public static protocols.replication.Failure.Builder newBuilder() {
    return new protocols.replication.Failure.Builder();
  }
   ...
   * @return A new Failure RecordBuilder
   */
  public static protocols.replication.Failure.Builder newBuilder(protocols.replication.Failure.Builder other) {
    return new protocols.replication.Failure.Builder(other);
  }
   ...
   * @return A new Failure RecordBuilder
   */
  public static protocols.replication.Failure.Builder newBuilder(protocols.replication.Failure other) {
    return new protocols.replication.Failure.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificErrorBuilderBase<Failure>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(protocols.replication.Failure.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(protocols.replication.Failure other) {
      super(other);
      if (isValidValue(fields()[0], other.info)) {
        this.info = data().deepCopy(fields()[0].schema(), other.info);
        fieldSetFlags()[0] = true;
    ...
    @Override
    public protocols.replication.Failure.Builder setValue(Object value) {
      super.setValue(value);
      return this;
    }

    @Override
    public protocols.replication.Failure.Builder clearValue() {
      super.clearValue();
      return this;
    }

    @Override
    public protocols.replication.Failure.Builder setCause(Throwable cause) {
      super.setCause(cause);
      return this;
    }

    @Override
    public protocols.replication.Failure.Builder clearCause() {
      super.clearCause();
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public protocols.replication.Failure.Builder setInfo(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public protocols.replication.Failure.Builder clearInfo() {
      info = null;
