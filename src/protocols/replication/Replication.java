...
public interface Replication {
  ...
  /**
   * Each time a fridge gets opened, this method will be called
   */
  java.lang.Void openFridge(protocols.replication.FridgeStatus data) throws org.apache.avro.AvroRemoteException, protocols.replication.Failure;
  /**
   * Each time a fridge gets opened, this method will be called
   */
  java.lang.Void closeFridge(protocols.replication.FridgeStatus data) throws org.apache.avro.AvroRemoteException, protocols.replication.Failure;
  ...
  public interface Callback extends Replication {
     ...
     */
    void setup(protocols.replication.Controller controller, org.apache.avro.ipc.Callback<java.lang.Void> callback) throws java.io.IOException;
    /**
     * Each time a new entity gets registered in the controller, this method will be called
     * @throws java.io.IOException The async call could not be completed.
     */
     ...
     * @throws java.io.IOException The async call could not be completed.
     */
    void openFridge(protocols.replication.FridgeStatus data, org.apache.avro.ipc.Callback<java.lang.Void> callback) throws java.io.IOException;
    /**
     * Each time a fridge gets opened, this method will be called
     * @throws java.io.IOException The async call could not be completed.
     */
    void closeFridge(protocols.replication.FridgeStatus data, org.apache.avro.ipc.Callback<java.lang.Void> callback) throws java.io.IOException;
  }
}