...
public interface Controller {
  ...
  /**
   * Information to restart the controller
   */
  java.lang.Void restart(java.util.List<protocols.controller.LightStatus> lightStatusses, java.util.List<protocols.controller.FridgeStatus> openFridges, java.util.List<protocols.controller.TemperatureHistory> temperatureHistories, int amountOfMeasurements, double time) throws org.apache.avro.AvroRemoteException, protocols.controller.Failure;
  /**
  ...
  public interface Callback extends Controller {
     ...
     * @throws java.io.IOException The async call could not be completed.
     */
    void restart(java.util.List<protocols.controller.LightStatus> lightStatusses, java.util.List<protocols.controller.FridgeStatus> openFridges, java.util.List<protocols.controller.TemperatureHistory> temperatureHistories, int amountOfMeasurements, double time, org.apache.avro.ipc.Callback<java.lang.Void> callback) throws java.io.IOException;
    /**
     * Get the time from the controller
     * @throws java.io.IOException The async call could not be completed.
     */
